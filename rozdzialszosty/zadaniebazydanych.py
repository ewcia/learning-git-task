...
# sytuacja gdzie jest wiecej tabel i wiecej atrybutów
...
if __name__ == "__main__":
   ...
   print("We have {started} started and {stopped} stopped".format(
       started = select_task_by_status(conn, "started"), 
       stopped = select_task_by_status(conn, "stopped")))
   
   update(conn, "tasks", task_id, status="started")
   print("We have {started} started and {stopped} stopped".format(
       started = select_task_by_status(conn, "started"), 
       stopped = select_task_by_status(conn, "stopped")))
   
   update(conn, "tasks", task_id, status="stopped")
   print("We have {started} started and {stopped} stopped".format(
       started = select_task_by_status(conn, "started"), 
       stopped = select_task_by_status(conn, "stopped")))
   conn.close()
